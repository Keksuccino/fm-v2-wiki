...
published: true
date: 2022-08-02T21:30:22.704Z
tags: guide, json, jsonpath
editor: markdown
dateCreated: 2022-08-02T21:30:21.271Z
---

# 0. About

[Jayway JsonPath](https://github.com/json-path/JsonPath) is used for the **JSON Parser** text placeholder, to get content from a JSON file.
This page explains JSON paths in detail.

The text on this page is a copy of the README of the Jayway JsonPath repository.
